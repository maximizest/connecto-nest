...
export const ENV_KEYS = {
  ...
  TEST_REDIS_USERNAME: 'TEST_REDIS_USERNAME',
  ...
  // 스트리밍 최적화
  STREAMING_CDN_BASE_URL: 'STREAMING_CDN_BASE_URL',
  STREAMING_TEMP_DIR: 'STREAMING_TEMP_DIR',
  STREAMING_MAX_CONCURRENT: 'STREAMING_MAX_CONCURRENT',
  STREAMING_ENABLE_HLS: 'STREAMING_ENABLE_HLS',
  STREAMING_SEGMENT_DURATION: 'STREAMING_SEGMENT_DURATION',
} as const;
