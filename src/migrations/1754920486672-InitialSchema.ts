...
export class InitialSchema1754920486672 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_357d60c1b7e4a2e9466d6ff356" ON "notifications" ("travelId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0c92fb969e67cbf7208462ebc0" ON "notifications" ("planetId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b3bff6ef995abfa317b8ec8699" ON "notifications" ("scheduledAt") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."performance_metrics_type_enum" AS ENUM('api_response_time', 'database_query_time', 'cache_hit_rate', 'file_upload_speed', 'file_download_speed', 'file_processing_time', 'websocket_connection', 'memory_usage', 'cpu_usage', 'disk_usage', 'error_rate', 'concurrent_users')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."performance_metrics_category_enum" AS ENUM('api', 'database', 'cache', 'file_storage', 'websocket', 'system', 'error', 'user')`,
    );
    await queryRunner.query(
      `CREATE TABLE "performance_metrics" ("id" SERIAL NOT NULL, "type" "public"."performance_metrics_type_enum" NOT NULL, "category" "public"."performance_metrics_category_enum" NOT NULL, "resourceType" character varying(50), "resourceId" bigint, "value" numeric(10,4) NOT NULL, "unit" character varying(20) NOT NULL DEFAULT 'ms', "metadata" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_66237d8c606d64c7bd44a91f74a" PRIMARY KEY ("id")); COMMENT ON COLUMN "performance_metrics"."type" IS '메트릭 타입'; COMMENT ON COLUMN "performance_metrics"."category" IS '메트릭 카테고리'; COMMENT ON COLUMN "performance_metrics"."resourceType" IS '리소스 타입 (travel, planet, message, file)'; COMMENT ON COLUMN "performance_metrics"."resourceId" IS '리소스 ID'; COMMENT ON COLUMN "performance_metrics"."value" IS '메트릭 값'; COMMENT ON COLUMN "performance_metrics"."unit" IS '메트릭 단위 (ms, MB, %, count 등)'; COMMENT ON COLUMN "performance_metrics"."metadata" IS '추가 메타데이터'; COMMENT ON COLUMN "performance_metrics"."createdAt" IS '메트릭 수집 시간'`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2bef716900dbbccbd555e5c12b" ON "performance_metrics" ("resourceType", "resourceId", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2125db1843eac07c93e51ffc44" ON "performance_metrics" ("category", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4a6d170110f78c019d52a3a219" ON "performance_metrics" ("type", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."performance_alerts_metrictype_enum" AS ENUM('api_response_time', 'database_query_time', 'cache_hit_rate', 'file_upload_speed', 'file_download_speed', 'file_processing_time', 'websocket_connection', 'memory_usage', 'cpu_usage', 'disk_usage', 'error_rate', 'concurrent_users')`,
    );
    await queryRunner.query(
      `CREATE TABLE "performance_alerts" ("id" SERIAL NOT NULL, "metricType" "public"."performance_alerts_metrictype_enum" NOT NULL, "severity" character varying(20) NOT NULL, "title" character varying(200) NOT NULL, "description" text NOT NULL, "threshold" numeric(10,4) NOT NULL, "currentValue" numeric(10,4) NOT NULL, "resourceType" character varying(50), "resourceId" bigint, "isResolved" boolean NOT NULL DEFAULT false, "resolvedAt" TIMESTAMP, "context" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b2c8afd8c56b21d899190efada5" PRIMARY KEY ("id")); COMMENT ON COLUMN "performance_alerts"."metricType" IS '관련 메트릭 타입'; COMMENT ON COLUMN "performance_alerts"."severity" IS '알람 심각도 (low, medium, high, critical)'; COMMENT ON COLUMN "performance_alerts"."title" IS '알람 제목'; COMMENT ON COLUMN "performance_alerts"."description" IS '알람 설명'; COMMENT ON COLUMN "performance_alerts"."threshold" IS '임계값'; COMMENT ON COLUMN "performance_alerts"."currentValue" IS '현재 값'; COMMENT ON COLUMN "performance_alerts"."resourceType" IS '관련 리소스 타입'; COMMENT ON COLUMN "performance_alerts"."resourceId" IS '관련 리소스 ID'; COMMENT ON COLUMN "performance_alerts"."isResolved" IS '해결 여부'; COMMENT ON COLUMN "performance_alerts"."resolvedAt" IS '해결 시간'; COMMENT ON COLUMN "performance_alerts"."context" IS '추가 컨텍스트 정보'; COMMENT ON COLUMN "performance_alerts"."createdAt" IS '알람 생성 시간'`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_98beeb207e1899f23889784fa0" ON "performance_alerts" ("severity", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c97dc2425b67aca17c4a4aca94" ON "performance_alerts" ("isResolved", "createdAt") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_756bc06193e427679971a1b753"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d6d9a00c97d66c1a19002c7f3c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b5d15fe035bac2ad94309fb197"`,
    );
    await queryRunner.query(`DROP TABLE "file_scan_results"`);
    await queryRunner.query(
      `DROP TYPE "public"."file_scan_results_threatlevel_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a51f029a276f27bfe2aa5f45eb"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_47cc1acf1ebcf1339703ce5ff6"`,
    );
    await queryRunner.query(`DROP TABLE "blocked_ips"`);
    await queryRunner.query(`DROP TYPE "public"."blocked_ips_risklevel_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9f116fc4d9a5d4b71c9ef5fd75"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0f06b2b465fad556113072868c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9fbca62d08363c92a9d9b018e7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4d52eb18cb798b56183a5ba026"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f3e3edb95aee90264572beb037"`,
    );
    await queryRunner.query(`DROP TABLE "security_events"`);
    await queryRunner.query(`DROP TYPE "public"."security_events_status_enum"`);
    await queryRunner.query(
      `DROP TYPE "public"."security_events_risklevel_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9ae7bd3626371cc459b2fc5abd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_017f608d9e982cd3dac97c24b7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_483f310ad49bb8d80d328ec1cb"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c0ace4433aa579fd89ca8a9263"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5c35f68cf9bffba7318d38df06"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4e9da7cade0e9edd393329bb32"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a53cb2bff1e60b60dc581f86e0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_315ecd98bd1a42dcf2ec4e2e98"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c97dc2425b67aca17c4a4aca94"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_98beeb207e1899f23889784fa0"`,
    );
    await queryRunner.query(`DROP TABLE "performance_alerts"`);
    await queryRunner.query(
      `DROP TYPE "public"."performance_alerts_metrictype_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4a6d170110f78c019d52a3a219"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2125db1843eac07c93e51ffc44"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2bef716900dbbccbd555e5c12b"`,
    );
    await queryRunner.query(`DROP TABLE "performance_metrics"`);
    await queryRunner.query(
      `DROP TYPE "public"."performance_metrics_category_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."performance_metrics_type_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b3bff6ef995abfa317b8ec8699"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0c92fb969e67cbf7208462ebc0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_357d60c1b7e4a2e9466d6ff356"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a8d9e131a97cc6e9d00979720c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_efb0bbda7c7b63593f3b65db2d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7ddb1767051ba238bb698c3e08"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_19da8ae5e50dce0825eeaf1d1f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7f7b67c0ae5e101b71e86a0cf5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7ed6d4b0e2e5467752cb14a44d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0f60eaca1334fca31ef3c28588"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2de1d3124c07ed32d4c9e0c2a6"`,
    );
