...
export class RemoveAdminOwnership1755049862856 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "travels" DROP COLUMN "createdByAdminId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "createdByAdminId"`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "createdByAdminId" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "createdByAdminId" integer NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_70e93ed2463be4bc70452603c4" ON "planets" ("type", "createdByAdminId") `,
    );
    await queryRunner.query(
