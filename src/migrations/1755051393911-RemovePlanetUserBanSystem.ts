...
export class RemovePlanetUserBanSystem1755051393911
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "planet_users" DROP COLUMN "isBanned"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planet_users" DROP COLUMN "bannedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planet_users" DROP COLUMN "bannedBy"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planet_users" DROP COLUMN "banReason"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."planet_users_status_enum" AS ENUM('active', 'left', 'invited', 'muted')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."planet_users_status_enum_old" AS ENUM('active', 'left', 'banned', 'invited', 'muted')`,
    );
    await queryRunner.query(
      `ALTER TABLE "planet_users" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "planet_users" ADD "bannedBy" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "planet_users" ADD "bannedAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "planet_users" ADD "isBanned" boolean NOT NULL DEFAULT false`,
    );
  }
}
