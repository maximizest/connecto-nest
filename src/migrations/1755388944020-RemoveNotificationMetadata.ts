...
export class RemoveNotificationMetadata1755388944020
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_status_enum_old" AS ENUM('cancelled', 'delivered', 'failed', 'pending', 'read', 'sent')`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" ALTER COLUMN "status" DROP DEFAULT`,
    );
