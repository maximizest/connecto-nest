...
export class RemoveDeliveryResults1755326206481 implements MigrationInterface {
  name = 'RemoveDeliveryResults1755326206481';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP COLUMN "deliveryResults"`,
    );
