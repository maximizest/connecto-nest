...
export class RemovePlanetUnusedColumns1755312658543
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "lastMessageAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "lastMessagePreview"`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" DROP COLUMN "lastMessageUserId"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "lastMessageUserId" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "lastMessagePreview" character varying(200)`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "lastMessageAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "messageCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "maxMembers" integer NOT NULL DEFAULT '100'`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "memberCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "planets" ADD "isActive" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
