...
export class RemoveMessageCountColumns1755313679056
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "messages" ADD "readCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "messages" ADD "replyCount" integer NOT NULL DEFAULT '0'`,
    );
  }
}
