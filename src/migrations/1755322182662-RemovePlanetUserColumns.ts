...
export class RemovePlanetUserColumns1755322182662 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "lastSeenAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "leftAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "invitedBy"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "invitedAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "respondedAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "lastReadMessageId"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "lastReadAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "unreadCount"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "isMuted"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "muteUntil"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "permissions"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "personalSettings"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "messageCount"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "fileCount"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "firstMessageAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "lastMessageAt"`);
        await queryRunner.query(`ALTER TABLE "planet_users" DROP COLUMN "metadata"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."planet_users_status_enum" AS ENUM('active', 'banned')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4b7423cc1117c15104daec4346" ON "travel_users" ("userId", "joinedAt") `);
        await queryRunner.query(`ALTER TABLE "travel_users" ADD CONSTRAINT "FK_5e444d7fbe7d18cc67c3b4bcf44" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE TYPE "public"."planet_users_status_enum_old" AS ENUM('active', 'left', 'invited', 'muted')`);
        await queryRunner.query(`ALTER TABLE "planet_users" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "lastMessageAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "firstMessageAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "fileCount" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "messageCount" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "personalSettings" json`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "permissions" json`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "muteUntil" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "isMuted" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "unreadCount" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "lastReadAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "lastReadMessageId" integer`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "respondedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "invitedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "invitedBy" integer`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "leftAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "lastSeenAt" TIMESTAMP`);
        await queryRunner.query(`CREATE TYPE "public"."planet_users_role_enum" AS ENUM('participant', 'moderator')`);
        await queryRunner.query(`ALTER TABLE "planet_users" ADD "role" "public"."planet_users_role_enum" NOT NULL DEFAULT 'participant'`);
