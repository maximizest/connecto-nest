...
export class SimplifyTravelEntity1755310864409 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "travels" DROP COLUMN "inviteCodeEnabled"`,
    );
    await queryRunner.query(`ALTER TABLE "travels" DROP COLUMN "maxPlanets"`);
    await queryRunner.query(
      `ALTER TABLE "travels" DROP COLUMN "maxGroupMembers"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "travels" DROP COLUMN "totalMessages"`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" DROP COLUMN "lastActivityAt"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "lastActivityAt" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "totalMessages" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "planetCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "memberCount" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "maxGroupMembers" integer NOT NULL DEFAULT '100'`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "maxPlanets" integer NOT NULL DEFAULT '10'`,
    );
    await queryRunner.query(
      `ALTER TABLE "travels" ADD "inviteCodeEnabled" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_profile_occupation_age" ON "profiles" ("age", "occupation") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_profile_gender_age" ON "profiles" ("gender", "age") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_profile_occupation" ON "profiles" ("occupation") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_profile_nickname" ON "profiles" ("nickname") `,
    );
    await queryRunner.query(
